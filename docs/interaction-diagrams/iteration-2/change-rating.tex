...
\begin{enumerate}
  \item b:= changeRateing(bid:String, reviewId:int, newRateing:int, newReview:string):boolean
  \item b:= changeRateing(bid:String, reviewId:int, newRateing:int, newReview:string):boolean
  \item book:= getBook(bid:String):Book
  \item b:= changeRateing(reviewId:int, newRateing:int, newReview:string):boolean
  \item b:= setRateing(newRating:int):boolean
