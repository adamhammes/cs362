...
\title{Interaction Diagram - Add Author Description}
\author{ Steve Monson }
...
\begin{enumerate}
  \item \texttt{b:= addAuthorDescription(aid:String, desc:String):boolean}
  \item \texttt{b:= addAuthorDescription(aid:String, desc:String):boolean}
  \item \texttt{a:= getAuthor(aid:String):Author}
  \item \texttt{b:= addAuthorDescription(desc:String):boolean}
